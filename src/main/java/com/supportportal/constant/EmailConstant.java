...
public class EmailConstant {
    ...
    public static final String USERNAME = "labiodh.amine90@gmail.com";
    public static final String PASSWORD = "ayqcnohjfiprvlud";
    public static final String FROM_EMAIL = "support@getarrays.com";
    public static final String CC_EMAIL = "";
    public static final String EMAIL_SUBJECT = "Maxi-Log, LLC - New Password";
